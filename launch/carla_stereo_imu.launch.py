# CARLA STEREO+IMU (diverges on CARLA car motion; valid for richer-motion data).
# Run: ros2 launch vins_fusion_ros2 carla_stereo_imu.launch.py ; ros2 bag play <bag> --clock
