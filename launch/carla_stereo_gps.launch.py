# CARLA STEREO + GPS (stereo-only VIO + global_fusion). Recommended CARLA pipeline.
# Run: ros2 launch vins_fusion_ros2 carla_stereo_gps.launch.py ; ros2 bag play <bag> --clock
