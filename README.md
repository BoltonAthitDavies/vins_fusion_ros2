...
| Horizon sweep — trajectory tracking | Horizon sweep — controller behavior |
|---|---|
| ![horizon track](figures/mpc_horizon_track.png) | ![horizon behavior](figures/mpc_horizon_behavior.png) |

| Lookahead sweep — trajectory tracking | Lookahead sweep — controller behavior |
|---|---|
| ![lookahead track](figures/mpc_lookahead_track.png) | ![lookahead behavior](figures/mpc_lookahead_behavior.png) |
